...
: ${AMENT_CURRENT_PREFIX:="/mnt/Data/Projects/workspace/src/ackermann_steering_vehicle/install/ackermann_steering_vehicle"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ackermann_steering_vehicle/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ackermann_steering_vehicle/environment/path.sh"
