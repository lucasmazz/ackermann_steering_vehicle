  ...
  max_velocity_{0.0}
{
  ...
  // Publishers for /desired_angle and /desired_velocity topics
  angle_publisher_ = create_publisher<std_msgs::msg::Float64>("/desired_angle", 1);
  velocity_publisher_ = create_publisher<std_msgs::msg::Float64>("/desired_velocity", 1);
...
void JoystickController::listener_callback(const sensor_msgs::msg::Joy::SharedPtr msg)
{
  ...
  desired_velocity_ = msg->axes[3] * max_velocity_;
}
...
void JoystickController::timer_callback()
{
  ...
  if (velocity_lock_enabled_) {
    ...
    velocity_msg->data = desired_velocity_;
  }
