  ...
  position_{0.0, 0.0}
{
  ...
  desired_speed_subscriber_ = create_subscription<std_msgs::msg::Float64>(
    "/desired_speed", 10,
    std::bind(&VehicleController::desired_speed_callback, this, std::placeholders::_1));
...
void VehicleController::desired_speed_callback(const std_msgs::msg::Float64::SharedPtr msg)
{
  last_message_time_ = get_clock()->now();  // Update timestamp
